...
namespace Tera.Services
{
    public class GuildService : IGuildService
    {
        ...
        public void AddNewGuild(List<Player> players, string guildName)
        {
            ...
            //DAOManager.guildDAO.SaveGuild(players, guildName);

            AddNewRank(g, new GuildMemberRank {RankId = 1, RankName = "GuildMaster"});
            AddNewRank(g, new GuildMemberRank {RankId = 2, RankName = "Initiate"});
            //DAOManager.guildDAO.AddGuildRank(g, new GuildMemberRank {RankId = 1, RankName = "GuildMaster"} );
            //DAOManager.guildDAO.AddGuildRank(g, new GuildMemberRank { RankId = 2, RankName = "Initiate" });
        ...
        public void AddMemberToGuild(Player player, Guild guild, Player inviter = null)
        {
            ...
            lock (guild.MembersLock)
            {
                if (guild.GuildMembers == null || guild.GuildMembers.Count == 0)
                {
                    ...
                    //DAOManager.guildDAO.AddCharacterToGuild(player, guild);
                }
                else
                {
